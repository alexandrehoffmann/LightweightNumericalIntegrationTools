...
public:
	 ...
	 */
	template<class Function> constexpr LongScalar integrateLeftInfinite  (const Function& f, const Scalar a = 0.) const;
	/**
	 ...
	 * @return Approximated integral value.
	 */
	template<class Function> constexpr LongScalar integrateRightInfinite (const Function& f, const Scalar a = 0.) const;
private:
	static constexpr std::array<Scalar, 33> s_wi = {
		...
		Scalar(9.3310592514615706576 ), Scalar(11.303622656587531387 ), Scalar(15.566291494163869906)};
	static constexpr std::array<Scalar, 33> s_xi = {
		Scalar(0.043161135617326892192), Scalar(0.22751780280337112385), Scalar(0.55961665585153988759), Scalar(1.0402685077510020538), Scalar(1.6705591960757151909), 
		Scalar(2.4519207958976305465  ), Scalar(3.3861553375880048323 ), Scalar(4.4754594983997714570 ), Scalar(5.7224547202721035227), Scalar(7.1302243444001080163), 
		Scalar(8.7023592306214062489  ), Scalar(10.443013650205982427 ), Scalar(12.356973759350285962 ), Scalar(14.449741681585540238), Scalar(16.727639218638322353), 
		Scalar(19.197936587212446637  ), Scalar(21.869013524928189871 ), Scalar(24.750562906157795643 ), Scalar(27.853851111413356780), Scalar(31.192055545575129868), 
		Scalar(34.780709153538337700  ), Scalar(38.638296717774030225 ), Scalar(42.787072078253479488 ), Scalar(47.254206602993265817), Scalar(52.073451901514220267), 
		Scalar(57.287634541092940075  ), Scalar(62.952565946906630207 ), Scalar(69.143513380109892446 ), Scalar(75.966687014247062344), Scalar(83.581637223270880761), 
		Scalar(92.251139444135101234  ), Scalar(102.47784433682332258 ), Scalar(115.55475644899580731 )};
};

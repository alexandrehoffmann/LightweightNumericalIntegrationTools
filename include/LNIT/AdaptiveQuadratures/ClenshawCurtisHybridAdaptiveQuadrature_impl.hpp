...
{	
    ...
    const LongScalar I1 = LongScalar(0.5)*(xmax - xmin)*std::inner_product(std::cbegin(s_wi),          std::cend(s_wi),          std::cbegin(m_fx), LongScalar(0));
    const LongScalar I2 = LongScalar(0.5)*(xmax - xmin)*std::inner_product(std::cbegin(s_alternateWi), std::cend(s_alternateWi), std::cbegin(m_fx), LongScalar(0));

...
public:
	...
	/**
	 * @brief Integrate a function using the sub-intervals already stored in the class.
	 * @details This avoids the overhead of the adaptive refinement process by reusing 
	 * the subdivision mesh generated by a previous integration.
	 */
	template<class Function> std::invoke_result<Function, Scalar> integrateWithoutAdaptation(const Function& f) const;
